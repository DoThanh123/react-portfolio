        ...
        <>
            <div className="container contact-page">
                ...
                <div className="info-map">
                    ...
                    Viet Nam,
                    <br />
                    Chau Phong, Lien Ha, Dong Anh, Ha Noi <br />
                    <span>ruthra20220@gmail.com</span>
                </div>

                <div className="map-wrap">
                    <MapContainer center={[21.140542, 105.8980272]} zoom={13}>
                        <TileLayer url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" />
                        <Marker position={[21.140542, 105.8980272]}>
